...
//$query="SELECT * FROM " . T_USERS . " f1 INNER JOIN " . T_FOLLOWERS . " f2 ON f1.user_id = f2.following_id WHERE f1.username LIKE '$letter%'";
$query="SELECT * FROM Wo_Users f1 INNER JOIN Wo_Followers f2 ON f1.user_id = f2.following_id WHERE f1.username LIKE '$letter%' GROUP BY following_id";
