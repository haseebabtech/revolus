<?php 
if ($f == "notify_memories" && isset($wo['user']['notification_settings']) && isset($wo['loggedin']) && !empty($wo['config']['memories_system']) && !empty($wo['user']['notification_settings']['e_memory'])) {
