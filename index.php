...
<meta name="theme-color" content="#4d91ea">
<link rel="apple-touch-icon" href="themes/wowonder/img/icon192.png">
...
if ($wo['config']['membership_system'] == 1) {
        ...
        if ($wo['user']['is_pro'] != 0 || Wo_IsAdmin()) {
            switch ($page) {
                ...
                case 'video-call-api':
                    ...
                    break;
                case 'video-group-call':
                    //echo 'video-group-call 1';die;
                    include('sources/video_group_call.php');
                    break;
                case 'audio-group-call':
                    //echo 'audio-group-call 1';die;
                    include('sources/audio_group_call.php');
                    break;
                case 'home':
                ...
                case 'messages':
                    ...
                    break;
                case 'thankful':
                    include('sources/thankful.php');
                    break;
                case 'learn':
                    include('sources/learn.php');
                    break;
                case 'notebook':
                    include('sources/notebook.php');
                    break;
                case 'logout':
                ...
                case 'contact-us':
                    ...
                    break;
                case 'apple-login-test':
                    include('sources/apple_login_test.php');
                    break;
                case 'applesignin':
                    include('sources/applesignin.php');
                    break;
               ...
               case 'oauth':
                ...
                case 'live':
                    ...
                    break;
                case 'custom-login':
                    include('sources/custom_login.php');
                    break;
                    case 'culture':
                    include('sources/culture/create.php');
                    break;
                case 'authorizepay':
                    include('sources/authorizepay.php');
                break;
                case 'payment':
                    include('sources/authorizepayment.php');
                break;
            }
        }
        else{
    ...
    switch ($page) {
        ...
        case 'video-call-api':
            ...
            break;
        case 'video-group-call':
            //echo 'video-group-call 2';die;
            include('sources/video_group_call.php');
            break;
        case 'audio-group-call':
            //echo 'audio-group-call 2';die;
            include('sources/audio_group_call.php');
            break;
        case 'home':
            include('sources/home.php');
