...
function Wo_GetBlogs($args = array(), $blg_id=0) {
    global $sqlConnect, $wo;
    $options   = array(
        "category" => false,
        "offset" => 0,
...
function Wo_GetFriendsStatus($data_array = array('limit' => 8, 'user_id' => 0,'offset' => 0)) {
    ...
    $query     = "SELECT  DISTINCT user_id FROM Wo_UserStory ORDER BY user_id DESC" ;
...
function StartCloudRecording($vendor,$region,$bucket,$accessKey,$secretKey,$cname,$uid,$post_id)
{
    ...
    // $dt_arr[1]['agora_app_id'] = $wo['config']['agora_app_id'];
    // $dt_arr[1]['agora_customer_id'] = $wo['config']['agora_customer_id'];
    // $dt_arr[1]['agora_customer_certificate'] = $wo['config']['agora_customer_certificate'];
    // return $dt_arr;die;

    //$insarr = [];
    //$insarr[] = "https://api.agora.io/v1/apps/".$wo['config']['agora_app_id']."/cloud_recording/acquire";
    //$insarr[] = array('Authorization: Basic '.base64_encode($wo['config']['agora_customer_id'].":".$wo['config']['agora_customer_certificate']),'Content-Type: application/json;charset=utf-8');
    //$insarr[] = $data;
    //return $insarr;
    //return array('Authorization: Basic '.base64_encode($wo['config']['agora_customer_id'].":".$wo['config']['agora_customer_certificate']),'Content-Type: application/json;charset=utf-8');
