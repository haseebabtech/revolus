...
foreach ($get_activities as $key => $activity) {
	...
	$post_publisher              =  !empty($activity['postData']) && !empty($activity['postData']['publisher']) && !empty($activity['postData']['publisher']['name']) ? $activity['postData']['publisher']['name'] : '';
	$orginal_txt                 = array(
	    "{user}",
	);
	...
	$activity['activity_text'] = Wo_LanguageTranslate($activity['activity_text'], $detect_language, $translate_language);

	if(isset($activity['activator']) && !empty($activity['activator']['about'])){
		$activity['activator']['about'] = Wo_LanguageTranslate($activity['activator']['about'], $detect_language, $translate_language);
	}
