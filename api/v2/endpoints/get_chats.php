...
if (!empty($messages)) {
    foreach ($messages as $value) {
        ...
        if(isset($value['username'])){
            $value['username'] = Wo_LanguageTranslate($value['username'], $detect_language, $translate_language);
        }
        if(isset($value['about'])){
            $value['about'] = Wo_LanguageTranslate($value['about'], $detect_language, $translate_language);
        }
        if(isset($value['name'])){
            $value['name'] = Wo_LanguageTranslate($value['name'], $detect_language, $translate_language);
        }
        if(isset($message['text'])){
            $message['text'] = Wo_LanguageTranslate($message['text'], $detect_language, $translate_language);
        }
        if(isset($message['messageUser']) && isset($message['messageUser']['username'])){
            $message['messageUser']['username'] = Wo_LanguageTranslate($message['messageUser']['username'], $detect_language, $translate_language);
        }
        if(isset($message['messageUser']) && isset($message['messageUser']['name'])){
            $message['messageUser']['name'] = Wo_LanguageTranslate($message['messageUser']['name'], $detect_language, $translate_language);
        }
