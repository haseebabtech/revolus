...
if (empty($error_code)) {
    ...
    if (empty($recipient_data)) {
		...
		if (!empty($data['user_data'])) {
			...
			if(isset($recipient_data['username'])){
				$recipient_data['username'] = Wo_LanguageTranslate($recipient_data['username'], $detect_language, $translate_language);
			}
		...
		if (!empty($data['followers'])) {
			...
			foreach ($followers as $key => $follower) {
				...
				if(isset($follower['username'])){
					$follower['username'] = Wo_LanguageTranslate($follower['username'], $detect_language, $translate_language);
				}
				// Translate Language Ends
