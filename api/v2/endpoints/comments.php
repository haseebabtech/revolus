    ...
    if ($_POST['type'] == 'create') {
        if (!empty($_POST['post_id']) && is_numeric($_POST['post_id']) && $_POST['post_id'] > 0) {
            if (!empty($_FILES['image']) || !empty($_POST['text']) || !empty($_FILES['audio'])) {
                ...
                $text_comment = Wo_LanguageTranslate($text_comment, $detect_language, $translate_language);
    ...
    if ($_POST['type'] == 'create_reply') {
        if (!empty($_POST['comment_id']) && (!empty($_POST['text']) || !empty($_FILES['image']))) {
            ...
            if (!empty($comment)) {
                ...
                $detect_language = !empty($_POST['detect_language']) ? $_POST['detect_language'] : '';
                $translate_language = !empty($_POST['translate_language']) ? $_POST['translate_language'] : '';
                $comment['text'] = Wo_LanguageTranslate($comment['text'], $detect_language, $translate_language);
                // Translate Language Ends
        ...
        if (!empty($_POST['post_id'])) {
            ...
            if (!empty($post)) {
                ...
                foreach ($comments as $key => $value) {
                    ...
                    $detect_language = !empty($_POST['detect_language']) ? $_POST['detect_language'] : '';
                    $translate_language = !empty($_POST['translate_language']) ? $_POST['translate_language'] : '';
                    $comments[$key]['text'] = Wo_LanguageTranslate($comments[$key]['text'], $detect_language, $translate_language);
					// Translate Language Ends
    ...
    if ($_POST['type'] == 'fetch_comments_reply') {
        if (!empty($_POST['comment_id'])) {
            ...
            foreach ($replies as $key => $value) {
                ...
                $detect_language = !empty($_POST['detect_language']) ? $_POST['detect_language'] : '';
                $translate_language = !empty($_POST['translate_language']) ? $_POST['translate_language'] : '';
                $replies[$key]['text'] = Wo_LanguageTranslate($replies[$key]['text'], $detect_language, $translate_language);
                // Translate Language Ends
            }
