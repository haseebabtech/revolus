...
// Login With Apple Starts
if(isset($provider) && $provider == 'Apple'){
    ...
    if($user_email != ''){
        ...
        if (Wo_EmailExists($user_email) === true) {
            ...
            $re_data      = array(
                ...
                'first_name' => 'User_'.rand(1000, 9999), //Wo_Secure($name),
                'last_name' => 'Apple', //Wo_Secure($user_profile->lastName),
