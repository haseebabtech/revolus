...
<head>
    ...
    <style>
div#welcomeheader {
    background-image: url(https://jeanrobertrevolus.designpythons.com/Images/Untitled-3.png) !important;
...
nav.navbar {
    background: url(https://jeanrobertrevolus.designpythons.com/Images/Untitled-3.png) !important;
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <?php } ?>
                    <?php if ($is_admin == true) { ?>
                    <li <?php echo ($page == 'android-application-banner' || $page == 'android-application-notification') ? 'class="active"' : ''; ?>>
                    	<a href="#">
                    	...
                    	<ul class="ml-menu">
                    		<li>
                    			<a <?php echo ($page == 'android-application-banner') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('android-application-banner'); ?>">Application Settings</a>
                    		</li>
                    		<li>
                    			<a <?php echo ($page == 'android-application-notification') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('android-application-notification'); ?>">Notification</a>
                    		</li>
                    	</ul>
                    </li>
                    <?php } ?>
